  ...
  <div class="row">
    <div class="col-md-12"> <a href="#" onclick="document.getElementById('print').style.display='none';window.print();"><img src="../../img/print-icon.png" id="print" width="25" height="25" border="0" /></a>
      ...
      <div class="panel panel-default">
          ...
          <div class="panel-title">
            <div class="row">
              ...
              <div class="col-md-10 surat-title">
                ...
                <h2 class="text-center">Nama Penulis : <?php echo $_GET['penulis'] ?></h2>
        ...
        <?php
        $no=0;
                $sql = mysql_query("SELECT * FROM tbl_buku WHERE penulis ='$_GET[penulis]' ORDER BY id_buku ASC");
        ...
        <tr>
          ...
          <?php 
            $jumlah = mysql_num_rows(mysql_query("SELECT * FROM tbl_buku WHERE penulis = '$_GET[penulis]'"));
          ?>
